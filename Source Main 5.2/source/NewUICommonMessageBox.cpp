...
{
    const auto questGroup = static_cast<uint16_t>((g_pMyQuestInfoWindow->GetSelQuestIndex() & 0xFFFF0000) >> 16);
    const auto questNumber = static_cast<uint16_t>(g_pMyQuestInfoWindow->GetSelQuestIndex() & 0xFFFF);
