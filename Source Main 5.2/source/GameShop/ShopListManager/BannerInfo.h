...
public:
    ...
    wchar_t	BannerName[BANNER_LENGTH_NAME]{ 0 };				//  2. 배너 그룹 명
    wchar_t	BannerImageURL[INTERNET_MAX_URL_LENGTH]{ 0 };	//  3. 배너 이미지 URL
    ...
    wchar_t	BannerLinkURL[INTERNET_MAX_URL_LENGTH]{ 0 };		//  8. 배너 링크 URL
